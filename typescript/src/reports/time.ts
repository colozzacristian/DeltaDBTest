...
export async function writeTimeSyncInto(timeSync: TimeSync, keyboard: Keyboard): Promise<void> {
    ...
    if (kind === KeyboardKind.AK35I || kind === KeyboardKind.F75_MAX) {
        ...
        throw new Error("no implementation available for time sync for your keyboard");
    }
}
